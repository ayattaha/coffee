        ...
        <div class="row">
            <div class="col-md-12 col-sm-12 ">
                <div class="x_panel">
                    ...
                    <div class="x_content">
                        <br />
                        <form id="demo-form2" action="{{ route('insertBeverage') }}" method="POST"
                            ...
                            <div class="item form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="published" class="flat" value="1" @if(old('published')) checked @endif>
                                    </label>
                                </div>
                                @error('published')
                                <p class="text-danger">{{ $message }}</p>
                            ...
                            <div class="item form-group">
                                ...
                                <div class="checkbox">
                                    <label>
                                        <input type="checkbox" name="special_item" class="flat" value="1" @if(old('special_item')) checked @endif>
                                    </label>
                                </div>
                                @error('special_item')
                                <p class="text-danger">{{ $message }}</p>
